  ...
  return (
    <div className={`${styles.landing} ${styles.landingNext}`}>
      <header className={styles.header}>
        <Image
          src="/logo.svg"
          alt="Create Awesome Node App"
          className={styles.logo}
          width={40}
          height={40}
          unoptimized
        />
        <span className={styles.brand}>Create Awesome Node App</span>
      </header>
      ...
      <main className={styles.main}>
        ...
        <section
          ...
          style={{ "--index": features.length + 1 } as React.CSSProperties}
        >
          <h2 className={styles.sectionTitle}>Next steps</h2>
          <nav className={styles.docList} aria-label="Documentation">
            {docs.map((doc) => (
      ...
      <footer
        ...
        style={{ "--index": features.length + 2 } as React.CSSProperties}
      >
        <p>
          Generated with{" "}
          <a
